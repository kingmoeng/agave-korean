...
from .sources import ROOT, WEIGHTS, license_files, load_source, resolve_file, sha256
...
def build_source(source_id, offline=False):
    if source_id == "agave":
        ...
        for source_id in selected:
            try:
                ...
                if args.command == "build":
                    build_source(source_id, args.offline)
                else:
